...
class Social_Links_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'rs_social_links_widget', // Base ID
			esc_html__( 'Social Links Widget', 'rssl_domain' ), // Name
			array( 'description' => esc_html__( 'Output Social Icons Linked to Profiles', 'rssl_domain' ), ) // Args
		);
	}
	...
	public function getForm( $instance ) {
		...
		if(isset($instance['facebook_icon'])){
			...
			$facebook_icon = plugins_url() . '/rubsum-social-links/images/facebook.png';
		}
		...
		if(isset($instance['twitter_icon'])){
			...
			$twitter_icon = plugins_url() . '/rubsum-social-links/images/twitter.png';
		}
		...
		if(isset($instance['linkedin_icon'])){
			...
			$linkedin_icon = plugins_url() . '/rubsum-social-links/images/linkedin.png';
		}
		...
		if(isset($instance['google_icon'])){
			...
			$google_icon = plugins_url() . '/rubsum-social-links/images/google.png';
		}
